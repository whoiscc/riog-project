...
(function() {
  ...
  var $UpdateEventDescriptionText, Create, GetNumberEventText, GetSquareRotation, GetSquareX, GetSystemTimeText, OnFrame, Redraw;
  ...
  GetSquareX = function(t) {
    var t1;
    t1 = t % 2000;
    return (Math.min(t1, 2000 - t1)) / 1000;
  };

  GetSquareRotation = function(t) {
    return t % 360;
  };
